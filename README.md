...
fork from https://github.com/heyman/heynote. and change it to use tauri instead of electron. it reduce the size of the release image a lot. but it didnot reduce too much memory usage. 

to build it run `npm run tauri build`
